...
// The CollectRecordFunc type is an adapter to allow the use of ordinary
// function as CollectRecord mutator.
type CollectRecordFunc func(context.Context, *ent.CollectRecordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CollectRecordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CollectRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CollectRecordMutation", m)
}
