...
func (_c *NotificationCreate) SetTargetID(v uint64) *NotificationCreate {
	_c.mutation.SetTargetID(v)
	return _c
}

// SetNillableTargetID sets the "target_id" field if the given value is not nil.
func (_c *NotificationCreate) SetNillableTargetID(v *uint64) *NotificationCreate {
	if v != nil {
		_c.SetTargetID(*v)
	}
	return _c
...
func (_c *NotificationCreate) SetTargetType(v string) *NotificationCreate {
	_c.mutation.SetTargetType(v)
	return _c
}

// SetNillableTargetType sets the "target_type" field if the given value is not nil.
func (_c *NotificationCreate) SetNillableTargetType(v *string) *NotificationCreate {
	if v != nil {
		_c.SetTargetType(*v)
	}
	return _c
