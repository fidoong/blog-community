...
type User struct {
	...
	OauthProvider user.OauthProvider `json:"oauth_provider,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldUsername, user.FieldPasswordHash, user.FieldAvatarURL, user.FieldOauthProvider, user.FieldOauthID, user.FieldRole:
	...
	for i := range columns {
		...
		case user.FieldOauthProvider:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.OauthProvider = user.OauthProvider(value.String)
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.OauthProvider))
	builder.WriteString(", ")
