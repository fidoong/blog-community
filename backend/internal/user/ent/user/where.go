...
func OauthProviderEQ(v OauthProvider) predicate.User {
...
func OauthProviderNEQ(v OauthProvider) predicate.User {
...
func OauthProviderIn(vs ...OauthProvider) predicate.User {
...
func OauthProviderNotIn(vs ...OauthProvider) predicate.User {
